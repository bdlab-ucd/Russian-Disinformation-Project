...
class BarChartPlotter:
    ...
    def plot(self):
        ...
        case_names = [case_names[2], case_names[5], case_names[0], case_names[1], case_names[4], case_names[3]]
        measures = [measures[2], measures[5], measures[0], measures[1], measures[4], measures[3]]
        ...
        plt.ylabel('Measure')
        plt.title('{} Measure for Each of the Six Cases:'.format(self.measure_name))
